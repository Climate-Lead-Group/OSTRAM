...
concat_all_scenarios.py) and produces the 8-scenario comparison table,
...
Usage
-----
  python tools/analysis/analyse_sensitivity.py             # full run
  python tools/analysis/analyse_sensitivity.py --unittest  # validate metrics vs B_Opt anchors
"""
...
T1_ROOT = Path(__file__).resolve().parents[2] / "t1_confection"
COMBINED = T1_ROOT / "OSTRAM_Combined_Inputs_Outputs.csv"
CEIL_JSON = T1_ROOT / "sensitivity_expansion" / "reference" / "vre_ceilings_base.json"
BASE_JSON = T1_ROOT / "sensitivity_expansion" / "reference" / "b_opt_baseline.json"
OUT_CSV = T1_ROOT / "sensitivity_comparison.csv"
OUT_TXT = T1_ROOT / "sensitivity_report.txt"
