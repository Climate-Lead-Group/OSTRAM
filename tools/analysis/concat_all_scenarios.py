"""
concat_all_scenarios.py — stack OSTRAM per-scenario Input + output CSVs
======================================================================
...
Usage
-----
    python tools/analysis/concat_all_scenarios.py
    python tools/analysis/concat_all_scenarios.py --search-dir t1_confection/Executables \
