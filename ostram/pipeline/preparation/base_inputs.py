...
from ..scenarios.registry import ensure_root_output_directories, load_registry
...
SOURCE_INPUT_FOLDER = _PROJECT_PATHS.osemosys_inputs
INPUT_FOLDER = _PROJECT_PATHS.preparation_workspace / "og_csvs_inputs"
OUTPUT_FOLDER = _PROJECT_PATHS.a1_outputs
...
OLADE_GENERATION_FILE = (
    _PROJECT_PATHS.secondary_technology_inputs
    / "OSTRAM - Installed Capacity by Source - Annual.xlsx"
)
RUNTIME_COMPILATION_CONFIG = (
...
def main():
    ...
    if not RUNTIME_COMPILATION_CONFIG.exists():
        shutil.copy2(_PROJECT_PATHS.compilation_config, RUNTIME_COMPILATION_CONFIG)
    ...
    for scen in scenario_suffixes:
        ...
        try:
            update_yaml_structure(
                og_data=OG_Input_Data,
                yaml_path=RUNTIME_COMPILATION_CONFIG
            )
        except Exception as e:
