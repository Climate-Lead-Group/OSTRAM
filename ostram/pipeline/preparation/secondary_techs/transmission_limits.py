...
def main():
    runtime = resolve_paths().stage_workspace("preparation", create=True)
    flow_file = runtime / "secondary_techs" / "flujos_energia_estimados_optimizacion.xlsx"
    editor_file = runtime / "Secondary_Techs_Editor.xlsx"
