...
from ..configuration import get_ostram_country_mapping, get_ostram_tech_mapping, get_country_names, get_multi_region_map
...
def collect_data_from_all_scenarios():
    ...
    """
    base_path = resolve_paths().a1_outputs
...
def collect_trn_interconnections():
    ...
    base_year_path = (
        resolve_paths().a1_outputs
        / f"A1_Outputs_{base_scenario}"
...
def main():
    try:
        ...
        # Create template
        output_path = (
            resolve_paths().stage_workspace("preparation", create=True)
