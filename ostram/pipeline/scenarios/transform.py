...
def _resolve_script_yaml(script_name: str, scenario: str) -> Path | None:
    ...
    if not yaml_name:
        return None
    scenario_yaml = SCENARIO_CONFIG_DIR / scenario / yaml_name
...
def build_workdir(
    ...
    shutil.copy(
        ...
        else _PROJECT_PATHS.compilation_config,
...
def stage_6_sync_og_to_ts20(wd: Path, s1: Path) -> None:
    ...
    og_csvs_dir = _PROJECT_PATHS.preparation_workspace / "og_csvs_inputs"
    yaml_file = _PROJECT_PATHS.compilation_workspace / "Config_MOMF_T1_A.yaml"
