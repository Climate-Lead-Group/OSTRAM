...
Standalone A1-A6/result-analysis programs and their compatibility wrappers are not
maintained products and are absent from the active runtime tree. A helper with a
historical-looking name remains core when A3 or B2 still calls it.
