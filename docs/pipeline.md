...
2. For each scenario's Excel files:
   - Adds TRN entries to `A-O_AR_Model_Base_Year.xlsx` (sheets: **Secondary**, **Demand Techs**).
   - Adds TRN entries to `A-O_AR_Projections.xlsx` (sheets: **Secondary**, **Demand Techs**).
   - Adds TRN entries to `A-O_Parametrization.xlsx` (sheets: **Fixed Horizon Parameters**, **Demand Techs**).
